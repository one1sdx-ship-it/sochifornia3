...
const TAP_SLOP_PX = 18; // больший увод пальца — это жест прокрутки, а не тап. 18 (а не 12):
// в Chrome device-эмуляции палец при тапе на фоне инерции «дрожит» на 13–18px, из-за чего
// осознанный тап (напр. по «Каталог») ошибочно принимался за прокрутку и терялся. Реальный
// свайп уводит палец на 30px+ и по-прежнему считается прокруткой.
