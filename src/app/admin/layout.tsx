      ...
      <header className="border-b border-hairline bg-surface">
        <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-3 px-4 py-3">
          <nav className="flex items-center gap-3 text-sm">
            <Link href="/admin/tours" className="text-ink hover:text-primary">Туры</Link>
            <Link href="/admin/chats" className="text-ink hover:text-primary">Чаты</Link>
            {user.role === "ADMIN" && (
              <>
                <Link href="/admin/reviews" className="text-ink hover:text-primary">Отзывы</Link>
                <Link href="/admin/users" className="text-ink hover:text-primary">USERs</Link>
                <Link href="/admin/journal" className="text-ink hover:text-primary">Логи</Link>
              </>
            )}
          </nav>
